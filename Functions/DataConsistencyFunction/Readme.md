...
```bash
Serverless.UploadsNotificationLambda$ sam build
```
...
```bash
Serverless.UploadsNotificationLambda$ sam local invoke helloFromLambdaFunction --no-event
```
...
```bash
Serverless.UploadsNotificationLambda$ sam deploy
```
...
```bash
Serverless.UploadsNotificationLambda$ sam logs -n helloFromLambdaFunction --stack-name sam-app --tail
```
...
```bash
Serverless.UploadsNotificationLambda$ dotnet test test/Serverless.UploadsNotificationLambda.Tests/Serverless.UploadsNotificationLambda.Tests.csproj 
```
...
```bash
sam delete --stack-name Serverless.UploadsNotificationLambda
```
